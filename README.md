...
- Added support for Amiga OS 3.1.4:
  ...
  - Option to disable Scalos to fix NewIcons shown garbled or distorted. This replaces Scalos with following:
    - Added Full Palette for better colors in icons.
    - Added Tools Daemon for added options in Workbench top menu.
    - Added Magic Menu for right click menu in Wokrbench.
